document.addEventListener('DOMContentLoaded', function() {
        ...
        "Suite": {
            ...
            fotos: [
                ...
                },
                {
                    ...
                    titulo: "Casa de banho",
                    descricao: "Casa de banho espaçosa e premium"
                },
            ]
        },
        "Suite Familiar": {
    ...
    // Função para atualizar informações do apartamento
    ...
    function initializeMenuToggle() {
        ...
        // Verificar se há mais de um menu-toggle
        if (menuToggles.length > 1) {
            console.warn('Mais de um elemento .menu-toggle encontrado! Mantendo apenas o primeiro.');
            // Remover todos os menu-toggles adicionais
            for (let i = 1; i < menuToggles.length; i++) {
                menuToggles[i].remove();
            }
        }
        ...
        if (menuToggle.dataset.initialized) {
            console.log('Menu-toggle já inicializado, ignorando.');
            return;
        }
    ...
    console.log('Galeria de fotos (reservas) inicializada com sucesso');
});